...
\hypersetup{pdfkeywords={negative result, statistical power, data access, radiology report generation, automatic labelling, pre-registration}}
...
\paragraph{Keywords} negative result, statistical power, data access, radiology report generation, automatic labelling, pre-registration
