# Writing figures and the generated tex, and the label shaping the panels need.
...
# A hypergeometric tail on a draw this small can be far below any fixed number
# of decimals, so it is set in scientific notation rather than rounded to zero.
